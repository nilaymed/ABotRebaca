...
Feature: PBR03 RefApp Player SkipRewind Blocked LIVE Media

  Scenario: Run the refapp player for PBR validation with SkipRewind in LIVE Media
    ...
    And I input 4770 on app_token textbox
    And I input LIVE$25956 on Media UID textbox
