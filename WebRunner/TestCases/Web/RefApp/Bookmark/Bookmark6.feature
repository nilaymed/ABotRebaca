...
@Bookmark_Sanity
@Bookmark_wmc
Feature: Advanced Bookmark Verify bookmark feature for 2 accounts same media

  Scenario: Run the refapp player to verify bookmark feature for 2 accounts same media.
