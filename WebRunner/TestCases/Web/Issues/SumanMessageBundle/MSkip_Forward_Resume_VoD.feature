...
###########################################################################################
@RefApp_Player_VOD_Media_Skip_Forward_Resume1
...
Feature: RefApp_Player_VOD_Media_Skip_Forward_Resume
  ...
  Scenario: Run the refapp player to verify the Skip Forward(15s) Playback of VOD media
	...
	When I 1x-fast-forward the media for 2 time
	And I wait for 10 seconds
	When I 1x-fast-forward the media for 6 time
	And I wait for 10 seconds
	
	When I 1x-rewind the media for 1 time
	And I wait for 10 seconds
	
	When I 1x-rewind the media for 4 time
	And I wait for 10 seconds
