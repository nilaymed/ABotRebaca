...
@Confluence_Download_Status_Report
@confluence_sanity
@web_sanity



Feature: Confluence_Download_Status_Report
Scenario: Download a status report for a specific date (BCM Weekly Status Report - 09/18/2019)
...
When I open the Home page
  ...
  And I wait for the Password textbox to become available
	...
	And I input PassKey1 on Password textbox
