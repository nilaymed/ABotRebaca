@NewSoapValidation
  ...
  Feature: NewSoapValidation

  Scenario: NewSoapValidation : NewSoapValidation
  ...
  Then compare SOAP response with following parameters:
	  ...
	  | //*[local-name()='country'][1]/*[local-name()='population'][1]/text()     | {integer:eq}(46704314)  |
  ...
  | POPULATION                  | {integer:eq}(46704314)  |
