...
Feature: PBR04 RefApp Player FastForward Blocked LIVE Media

  Scenario: Run the refapp player for PBR validation with FastForward in LIVE Media
    ...
    And I input 4776 on app_token textbox
    And I input LIVE$2100009065 on Media UID textbox
