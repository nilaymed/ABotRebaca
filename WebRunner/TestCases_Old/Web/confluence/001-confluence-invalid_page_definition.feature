...
@Confluence_Invalid_Page_Definition
@confluence_sanity
@web_sanity



Feature: Confluence_Invalid_Page_Definition
...
When I open the Home page
  ...
  And I wait for the Password textbox to become available
	...
	And I input BosTec20#20 on Password textbox
	Then I click on the element Login link
	And I validate Confluence link to be present on page

# Load the Dashboard page and open the spaces link (Invalid Page Reference Dashboard_Tools)
When I open the Dashboard_Tools page
...
When I open the Status_Report page
  ...
  And I wait for the Action link to become available
