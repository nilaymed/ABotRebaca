...
@Youtube_Test_Feature_CFS_All_Demo
@Youtube_Sanity
@Youtube_Demo


Feature: @Appium_Youtube_Test_Feature_CFS_All_Demo
Scenario: Test YouTube media player with MOBILE Android Driver


Given all configured endpoints for MOBILE2 are connected successfully
...
When I play the media at index position 2 on device {abotprop.Android.Device1.Identification.String} for 5 seconds with snap rate delay of 2 seconds 
...
When I fast-forward the media by 5 times on device {abotprop.Android.Device1.Identification.String}

Then I validate that the media moved forward on device {abotprop.Android.Device1.Identification.String}

#Then I validate that the media seek was proper on device {abotprop.Android.Device1.Identification.String}
